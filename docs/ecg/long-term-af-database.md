...
| --- | --- | --- | --- |
| GB Moody et al. (2004) [^1] | AF Prediction | Hidden Markov Model (HMM),  SVM | RR interval variability and atrial activity frequency analysis | | RR interval variability and atrial activity frequency analysis | |
# 4. References
