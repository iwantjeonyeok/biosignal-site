...
| --- | --- | --- | --- | --- | --- |
| CPSC 2018 | 6877 | 12 | Fixed 500 Hz | Approximately 6 - 144 seconds | .hea (Metadata)
.mat (ECG) |
| CPSC 2018 Extrea | 3453 | 12 | Fixed 500 Hz | Approximately 8 - 98 seconds | .hea (Metadata)
.mat (ECG) |
| Georgia | 10344 | 12 | Fixed 500 Hz | 10 seconds
(5 seconds for only 5 samples) | .hea (Metadata)
.mat (ECG) |
| PTB | 516 | 12 | Fixed 1000 Hz | 115.2 seconds (except some samples) | .hea (Metadata)
.mat (ECG) |
| PTB-XL | 21837 | 12 | Fixed 500 Hz | 10 seconds | .hea (Metadata)
.mat (ECG) |
| St. Petersburg INCART | 74 | 12 | Fixed 257 Hz | 1800 seconds | .hea (Metadata)
.mat (ECG) |
