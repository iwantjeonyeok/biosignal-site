...
- [Paper (Open Reivew)](https://openreview.net/forum?id=6Hz1Ko087B)
...
3. linear interpolation을 통한 ECG signal **500 Hz resampling**
4. residual baseline drift 제거를 위한 **0.5 Hz high-pass filter** 적용
