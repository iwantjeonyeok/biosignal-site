...
신호를 정확히 복원하려면 최고 주파수 성분의 **2배 이상**으로 샘플링해야 합니다(Nyquist 원리). 

심장 신호의 최고 주파수가 약 **50 Hz** 정도이므로, 이론적 최소 샘플링 레이트는 **100 Hz**입니다. 그러나 실제로는 신호 품질 향상과 필터 설계의 편의를 위해 더 높은 레이트를 사용합니다.
