...
![Transformer, ResNET, EEG/EMG 기반 인식 모델 예시](./image-5.png)

**그림 4.** (a) Transformer 기반 silent speech recognition 모델 [35], (b) ResNET의 Inception block을 활용한 수화 인식 모델 [36], (c) EEG, EMG를 활용한 ResNET 기반 수면 상태 분류 모델 [37].
