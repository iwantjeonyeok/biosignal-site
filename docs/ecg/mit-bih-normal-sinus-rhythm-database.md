...
| --- | --- | --- | --- | --- |
| 1806792 records | 2 | ﻿Fixed 128 Hz
...
| --- | --- | --- | --- |
| N | 95.72%
(1729502/1806792) | 96083.4 | 10689.7 |
| S | 0.01%
(91/1806792) | 6.1 | 6.7 |
| |  | 3.88%
(70068/1806792) | 3892.7 | 8061 |
| ~ | 0.39%
(7095/1806792) | 394.2 | 457.1 |
| V | 0.0%
(26/1806792) | 5.2 | 5.4 |
| F | 0.0%
(8/1806792) | 4 | 2 |
...
![image.png](mit-bih-normal-sinus-rhythm-database/image.png)
...
![ECG_visualization_10000.png](mit-bih-normal-sinus-rhythm-database/ECG_visualization_10000.png)
...
![image.png](mit-bih-normal-sinus-rhythm-database/image-1.png)
...
| --- | --- | --- | --- |
| Huang et al.
(2010) [^1] | AF에서 정상 동리듬 전환 감지 | 신호 처리 | 심방세동과 정상 동리듬 간의 전환을 감지하는 새로운 방법을 개발함 |
| Sharma et al.
(2012) [^2] | ECG 리샘플링 및 균일 샘플링 | 데이터 처리 | ECG 파형을 원하는 간격으로 균일하게 리샘플링하는 기법을 제안함 |
|  |  |  |  |
|  |  |  |  |
|  |  |  |  |
|  |  |  |  |
