...
![](long-term-st-database/image.png)

![](long-term-st-database/image-1.png)
...
![](long-term-st-database/image-2.png)
...
![](long-term-st-database/image-3.png)

S20011.dat의 일부인 s20011의 ECG 신호입니다. 좌측은 표, 우측은 그래프입니다. 두개의 leads로부터 측정한 신호를 기록하였습니다.

![](long-term-st-database/image-4.png)

![](long-term-st-database/image-5.png)
