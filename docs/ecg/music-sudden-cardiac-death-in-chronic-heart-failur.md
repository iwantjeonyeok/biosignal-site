...
![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image.png)
...
![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image-1.png)
...
![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image-2.png)
...
![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image-3.png)

S20011.dat의 일부인 s20011의 ECG 신호입니다. 좌측은 표, 우측은 그래프입니다. 두개의 leads로부터 측정한 신호를 기록하였습니다.

![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image-4.png)

![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image-2.png)

.dat 파일은 ECG 신호에 대한 아래와 같은 정보들을 포함하고 있으며 아래와 같이 csv로 전환하였습니다.

![image.png](music-sudden-cardiac-death-in-chronic-heart-failur/image-5.png)
