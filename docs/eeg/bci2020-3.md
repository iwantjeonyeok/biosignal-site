...
| Han (2023) [3] | Calibration 없이도 일반화 가능한 MI-BCI 시스템 구축 | Gradient-based Meta-learning + Intermittent Freezing | 메타러닝 기반 zero-calibration EEG 프레임워크 제안. 간헐적 파라미터 동결 전략을 통해 class-relevant feature만 선택적으로 학습하고, 새로운 사용자(특히 stroke 환자)에게도 일반화 가능. |
