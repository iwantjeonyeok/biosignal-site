...
| --- | --- | --- | --- |
| N | 86.41%
(162339/187877) | 2081.3 | 485.9 |
| S | 6.49%
(12188/187877) | 167 | 261.9 |
| V | 5.29%
(9943/187877) | 148.4 | 174.9 |
| F | 0.01%
(23/187877) | 3.8 | 5.9 |
| |  | 1.18%
(2211/187877) | 48.1 | 102 |
| J | 0.0%
(9/187877) | 9 | 0 |
...
![image.png](mit-bih-supraventricular-arrhythmia-database/image.png)
...
![ECG_visualization_10000.png](mit-bih-supraventricular-arrhythmia-database/ECG_visualization_10000.png)
...
![image.png](mit-bih-supraventricular-arrhythmia-database/image-1.png)
...
| --- | --- | --- | --- |
| Paparrizos et al.
(2022)[^1] | 시계열 이상 탐지 벤치마킹
 | N/A  | 단변량(Univariate) 시계열 이상 탐지 기법을 평가하기 위한 종합 벤치마크(TSB-UAD) 개발, MIT-BIH Supraventricular Arrhythmia database를 핵심 데이터셋으로 포함.
 |
| Liu et al.  (2022)[^2] | 부정맥 분류 | LSTM 오토인코더 | 시계열 이상 탐지를 위한 LSTM 오토인코더를 활용하여 상심실성 부정맥을 분류. |
| Acharya et al.
(2017)[^3] | 심장 박동 분류 | 특징 선택 기법  | 데이터베이스 일반화 기준을 기반으로 특징 선택을 최적화하여 심장 박동 분류 성능 향상. |
| Zabihi et al.
(2019)[^4]
 | IoT 기반 eHealth에서 ECG 분류 | 머신러닝 모델  | IoT 기반 원격 건강 관리(eHealth)를 위한 지속 가능한 ECG 분류 시스템 BeatClass 개발. |
| Elgendi et al.
(2013)[^5]
 | QRS 검출 | 지식 기반 기법 | 11개의 표준 ECG 데이터베이스에서 최적화 및 평가된 빠른 QRS 검출 알고리즘 제안.
 |
| Kachuee et al.
(2018)[^6]
 | 심장 부정맥 분류
 | 순환 신경망(RNN)  | MIT-BIH Supraventricular
Arrhythmia database를 활용한 심장 박동 단위(arrhythmia beat-bybeat) 부정맥 분류 모델 개발. |
