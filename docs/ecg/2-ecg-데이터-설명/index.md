...
[2.1. Lead (리드)와 전극 배치](2-1-lead-리드와-전극-배치.md)

[2.2. Duration (측정 시간, 기록 길이)](2-2-duration-측정-시간-기록-길이.md)

[2.3. Sampling Frequency (샘플링 주파수, 신호 해상도)](2-3-sampling-frequency-샘플링-주파수-신호-해상도.md)

[2.4. P-QRS-T 복합체 (ECG 신호의 기본 구성 요소)](2-4-p-qrs-t-복합체-ecg-신호의-기본-구성-요소.md)

[2.5. Annotation (주석, 라벨링 정보)](2-5-annotation-주석-라벨링-정보.md)
