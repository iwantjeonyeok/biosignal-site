...
![](long-term-af-database/image.png)
...
![](long-term-af-database/image-1.png)

![](long-term-af-database/image-2.png)
...
| --- | --- | --- | --- |
| GB Moody et al. (2004) [1] | AF Prediction | Hidden Markov Model (HMM),  SVM | RR interval variability and   atrial activity frequency analysis |
