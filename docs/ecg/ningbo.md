...
| --- | --- | --- | --- |
| Zheng J et al.(2020) [1] | Multilabel classification | Gradient Boosting Tree(GBT), Extreme Gradient Boosting Tree(EGBT) | Group the specific label and classification the ECG data into each groups accurate.  Atrial fibrillation detection |
