...
| --- | --- | --- | --- | --- |
| 114839 records | ﻿2 (MLII, V1/2/4/5) |  ﻿Fixed 360 Hz
   | ﻿30 minutes
...
| --- | --- | --- | --- |
| +  | 1.13%
(1296/114839) | 26.4 | 42.1 |
| A | 2.22%
(2546/114839) | 94.3 | 265.2 |
| N | 65.44%
(75151/114839) | 1833 | 744 |
| V | 6.21%
(7134/114839) | 187.7 | 255.5 |
| Q | 0.03%
(33/114839) | 5.5 | 5.7 |
| | | 0.11%
(132/114839) | 6.9 | 8.9 |
| ~ | 0.54%
(616/114839) | 16.2 | 17.9 |
| F | 0.7%
(803/114839) | 47.2 | 117 |
| j | 0.2%
(229/114839) | 45.8 | 83.2 |
| x | 0.17%
(193/114839) | 38.6 | 48.6 |
| / | 7.89%
(9056/114839) | 1811.2 | 291.1 |
| f | 0.9%
(1038/114839) | 259.5 | 249 |
| L | 7.03%
(8075/114839) | 2018.8 | 371 |
| a | 0.13%
(150/114839) | 21.4 | 31.8 |
| J | 0.07%
(83/114839) | 16.6 | 19.8 |
| R | 6.32%
(7259/114839) | 1209.8 | 744 |
| ! | 0.41%
(472/114839) | 472 | 0 |
| E | 0.09%
(106/114839) | 53 | 52 |
...
![image.png](mit-bih-arrythmia-database/image.png)
...
![ECG_visualization_10000.png](mit-bih-arrythmia-database/ECG_visualization_10000.png)
...
![image.png](mit-bih-arrythmia-database/image-1.png)
...
| --- | --- | --- | --- |
| Rajpurkar et al.
(2017)[^1] | 부정맥 분류 | CNN  | 대규모 ECG 분류를 위한ResNet활용 |
| Acharya et al.
(2017)[^2] | 부정맥 분류 | CNN  | 다중 클래스 부정맥 분류를 위한 자동 특징 추출 |
| Yildirim et al.
(2018)[^3] | ECG 기반 생체
인증 | LSTM, CNN  | 개별 신원 확인을 위한 순환 신경망 기반 아키텍처 적용 |
| Hannun et al.
(2019)[^4] | 실시간 ECG
모니터링 | CNN  | 대규모 ECG 데이터셋으로 학습된 엔드투엔드 딥 러닝 모델 |
| Shashikumar et al.
(2020)[^5]
 | 심방세동 탐지 | Hybrid CNNLSTM | 개인 맞춤형 ECG 모니터링을 위한 적응형 딥 러닝 기법 |
| Acharya et al.
(2017)[^6] | 심방세동 탐지 | CNN  | ECG 신호를 활용한 심근 경색 분류 딥러닝 모델 |
